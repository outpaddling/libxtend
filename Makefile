...
LIB     = xtend
SLIB    = lib${LIB}.a
SONAME  = lib${LIB}.so.1    # Increment when the API changes
DLIB    = ${SONAME}.0       # Increment for changes that don't affect API
...
OBJS    = valid-extension.o xcfile.o strisnum.o strptrcmp.o difftimeofday.o \
	  ...
	  ltostrn.o strshellcpy.o num_size.o
...
install: all
	...
	${INSTALL} -m 0444 ${SLIB} ${DLIB} ${SONAME} ${DESTDIR}${PREFIX}/lib
